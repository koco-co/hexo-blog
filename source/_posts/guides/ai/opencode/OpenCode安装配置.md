...
abbrlink: c97f2813
cover: /img/picgo-images/opencode-install.webp
...
![OpenCode_for_VScode](/img/picgo-images/image-OpenCode_for_vscode.webp)
...
![vscode打开opencode命令面板](/img/picgo-images/image-vscode打开opencode.webp)
...
{% link Local MCP 配置, https://opencode.ai/docs/mcp-servers/#local, https://opencode.ai/favicon.ico %}
...
{% link Remote MCP 配置, https://opencode.ai/docs/mcp-servers/#remote, https://opencode.ai/favicon.ico %}
...
{% link OpenCode GitHub Integration, https://opencode.ai/docs/github.mdx, https://opencode.ai/favicon.ico %}
...
{% link OpenCode Commands, https://opencode.ai/docs/commands.mdx, https://opencode.ai/favicon.ico %}
...
{% link OpenCode Agents, https://opencode.ai/docs/agents.mdx, https://opencode.ai/favicon.ico %}
