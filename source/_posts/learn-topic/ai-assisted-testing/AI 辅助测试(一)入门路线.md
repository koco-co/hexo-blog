...
| 2 | AI 辅助测试(二)协作边界 | 明确需求、测试设计、生成、执行、业务验收和 Agent 的职责边界。 | G01 | 未开始 |
| 3 | AI 辅助测试(三)需求与测试设计 | 用覆盖、歧义、状态和风险把需求变成可检查测试计划。 | G02、E03、E04 | 未开始 |
| 4 | AI 辅助测试(四)数据与环境 | 建立业务数据工厂、约束、种子、隔离和重置环境。 | G03 | 未开始 |
| 5 | AI 辅助测试(五)单元测试生成 | 让生成的单元测试围绕独立 Oracle、已知缺陷和 mutation 结果验收。 | G04 | 未开始 |
| 6 | AI 辅助测试(六)API测试生成 | 把 OpenAPI、状态链、真实响应 ID 和清理动作转为可执行 API 测试。 | G04、G05 | 未开始 |
| 7 | AI 辅助测试(七)UI测试生成 | 将规划、生成、Playwright 执行、定位和工件职责分开。 | G03、G04、G05 | 未开始 |
| 8 | AI 辅助测试(八)探索式测试 | 用 charter、预算、观察、复现和跟进动作约束 Agent 探索。 | G06、G07、E10 | 未开始 |
| 9 | AI 辅助测试(九)缺陷分析与维护 | 把 healer 当候选补丁，而不是自动真修复，要求干净重跑和差异审查。 | G07、G08、E09、E10 | 未开始 |
| 10 | AI 辅助测试(十)测试资产验收 | 用缺陷、mutation、误报和人工接受度证明测试资产有效。 | G05、G06、G07、G08、G09、E05 | 未开始 |
| 11 | AI 辅助测试(十一)CI流水线 | 把生成作业、验证作业、来源、版本、失败证据和发布门禁分开。 | G09、G10、E18、B12、D12 | 未开始 |
| 12 | AI 辅助测试(十二)项目实战 | 交付一个带需求到 CI 的 AI 测试资产流水线，并证明安全、质量和维护边界。 | G11、D13、E19、F10 | 未开始 |
