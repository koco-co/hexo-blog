...
“进阶内容”是可选篇，项目实战不依赖其中的无障碍、视觉回归、WebSocket、GraphQL 或 BDD。常规 Web 自动化先完成第二至第十篇，再根据项目需要选择进阶能力。

## 文章目录

| 顺序 | 文章         | 核心成果                          | 前置 |
| ---- | ------------ | --------------------------------- | ---- |
| 一   | 学习路线     | 理解课程边界和阅读顺序            | 无   |
...
{% flashcard basic id:playwright-roadmap-mainline deck:"Playwright" tags:"学习路线,主线" %}
--- question
...
{% flashcard choice id:playwright-roadmap-optional deck:"Playwright" tags:"学习路线,进阶" answer:B %}
--- question
