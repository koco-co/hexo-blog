...
| 5 | [Pytest(五)Fixture 与资源生命周期](/posts/97e28b51/) | 依赖、作用域、缓存与清理 | 2、3 | 已完成 |
| 6 | [Pytest(六)参数化与用例建模](/posts/f6690364/) | 选择参数化、Fixture 参数和 subtests | 3、5 | 已完成 |
| 7 | [Pytest(七)隔离环境与测试替身](/posts/1d2bf183/) | 正确替换协作者并避免泄漏 | 4、5 | 已完成 |
| 8 | [Pytest(八)配置与套件组织](/posts/26397f68/) | 配置解析、导入和 conftest 边界 | 3、5、7 | 已完成 |
| 9 | [Pytest(九)插件与 Hook 扩展](/posts/c50d5948/) | 以插件与 Hook 扩展运行过程 | 3、5、8 | 已完成 |
| 10 | [Pytest(十)并行执行与稳定性](/posts/5497f9c8/) | 多进程下的隔离和 flaky 诊断 | 5、6、8、9 | 已完成 |
| 11 | [Pytest(十一)覆盖率与测试报告](/posts/51d93cec/) | 组织可追溯且不泄密的质量证据 | 4、8、10 | 已完成 |
| 12 | [Pytest(十二)进阶路线](/posts/76bdbbc7/) | 进入自定义收集和插件测试 | 6、8、9、11 | 已完成 |
| 13 | [Pytest(十三)项目实战](/posts/b428e868/) | 交付订单模块的完整测试套件 | 2–11 | 已完成 |
