...
| 2 | [Python(二)运行环境与代码组织](/posts/5891c180/) | 环境、入口、模块、包和导入 | 入门路线 | 已完成 |
| 3 | [Python(三)对象、变量与运算](/posts/76bec403/) | 名称绑定、对象、数字和字符串 | 第二篇 | 已完成 |
| 4 | [Python(四)内置类型与容器](/posts/c43fdd4/) | 容器选择、复制、排序与查找 | 第三篇 | 已完成 |
| 5 | [Python(五)流程控制与函数](/posts/a62147da/) | 流程、参数、作用域和闭包 | 第四篇 | 已完成 |
| 6 | [Python(六)迭代器、生成器与装饰器](/posts/be636c04/) | 惰性迭代、生成器和装饰器 | 第五篇 | 已完成 |
| 7 | [Python(七)面向对象与数据模型](/posts/1aeb52d0/) | 属性查找、方法绑定、继承和特殊方法 | 第六篇 | 已完成 |
| 8 | [Python(八)异常、上下文与文件](/posts/c31bf4bb/) | 异常、资源、文件、路径和正则 | 第七篇 | 已完成 |
| 9 | [Python(九)类型与质量保障](/posts/62348dbe/) | 类型、测试、调试、日志和测量 | 第八篇 | 已完成 |
| 10 | [Python(十)内存、并发与性能](/posts/fa1b960c/) | 生命周期、GC、GIL 与并发选型 | 第九篇 | 已完成 |
| 11 | [Python(十一)进阶路线](/posts/a99f76bc/) | 低频内部机制和旧接口迁移 | 第十篇 | 已完成（可选） |
| 12 | [Python(十二)项目实战](/posts/c55cda53/) | 命令行日志分析器 | 第十篇 | 已完成 |
